...
if sales_file and calls_file:
    ...
    if page == "Dashboard":
        ...
        # --- LINE CHARTS (now **always use filtered data** for agent/date!) ---
        manual_order = ["2024-12", "2025-01", "2025-02", "2025-03", "2025-04"]
        if selected_date == "All Time":
            df_filtered['month_period'] = pd.to_datetime(df_filtered['createdate_berlin'], errors='coerce').dt.to_period('M') # <--- FIXED FOR FILTERS
        ...
        # --- Product Distribution Pie Chart (always filtered) ---
